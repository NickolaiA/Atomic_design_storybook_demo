import{j as e}from"./jsx-runtime-CDt2p4po.js";import{f as L}from"./index-BxLnRenJ.js";import{r as A,R as C}from"./index-GiUgBvb1.js";const s=A.forwardRef(({size:i="base",checked:o,defaultChecked:n,disabled:t=!1,required:c=!1,label:l,description:r,onChange:pe,onFocus:we,onBlur:fe,className:ve="",id:ye,name:ge,value:xe,"aria-label":Se,"aria-describedby":je,"aria-labelledby":Ne,onLabel:k="On",offLabel:D="Off",showLabels:N=!1,variant:Le="primary",...Ce},ke)=>{const d=ye||`switch-${Math.random().toString(36).substr(2,9)}`,O=l?`${d}-label`:void 0,T=r?`${d}-description`:void 0,De=[je,T].filter(Boolean).join(" "),a="switch",Oe=`${a}--${i}`,Te=`${a}--${Le}`,Ee=t?`${a}--disabled`:"",Ae=N?`${a}--with-labels`:"",qe=[`${a}-container`,Oe,Te,Ee,Ae,ve].filter(Boolean).join(" "),Re=A.useCallback(h=>{if(!t&&(h.key===" "||h.key==="Enter")){h.preventDefault();const E=h.currentTarget.querySelector("input");E&&E.click()}},[t]);return e.jsxs("div",{className:qe,children:[e.jsxs("label",{className:`${a}-wrapper`,htmlFor:d,onKeyDown:Re,tabIndex:t?-1:0,role:"switch","aria-checked":o?"true":"false","aria-labelledby":Ne||O,"aria-describedby":De||void 0,"aria-disabled":t?"true":"false",children:[e.jsx("input",{ref:ke,type:"checkbox",id:d,name:ge,value:xe,checked:o,defaultChecked:n,disabled:t,required:c,onChange:pe,onFocus:we,onBlur:fe,className:`${a}-input`,"aria-label":Se,tabIndex:-1,...Ce}),e.jsxs("span",{className:`${a}-track`,children:[e.jsx("span",{className:`${a}-thumb`,children:N&&e.jsx("span",{className:`${a}-state-label`,children:o?k:D})}),N&&e.jsxs("span",{className:`${a}-track-labels`,children:[e.jsx("span",{className:`${a}-track-label ${a}-track-label--on`,children:k}),e.jsx("span",{className:`${a}-track-label ${a}-track-label--off`,children:D})]})]})]}),(l||r)&&e.jsxs("div",{className:`${a}-content`,children:[l&&e.jsxs("span",{id:O,className:`${a}-label`,children:[l,c&&e.jsx("span",{className:`${a}-required`,"aria-label":"required",children:"*"})]}),r&&e.jsx("span",{id:T,className:`${a}-description`,children:r})]})]})});s.displayName="Switch";s.__docgenInfo={description:`Switch component for boolean toggle inputs.\r
\r
Features:\r
...
}`,...(F=(R=m.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};var I,z,$;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...($=(z=u.parameters)==null?void 0:z.docs)==null?void 0:$.source}}};var B,M,V;b.parameters={...b.parameters,docs:{...(B=b.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => <div className="switch-story-section">\r
      <div className="switch-story-row">\r
...
}`,...(V=(M=b.parameters)==null?void 0:M.docs)==null?void 0:V.source}}};var H,U,W;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => <div className="switch-story-section">\r
      <div className="switch-story-row">\r
...
}`,...(W=(U=p.parameters)==null?void 0:U.docs)==null?void 0:W.source}}};var P,K,Y;w.parameters={...w.parameters,docs:{...(P=w.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => <div className="switch-story-section">\r
      <div className="switch-story-row">\r
...
}`,...(Y=(K=w.parameters)==null?void 0:K.docs)==null?void 0:Y.source}}};var _,G,J;f.parameters={...f.parameters,docs:{...(_=f.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(J=(G=f.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var Q,X,Z;v.parameters={...v.parameters,docs:{...(Q=v.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => <div className="switch-story-section">\r
      <div className="switch-story-row">\r
...
}`,...(Z=(X=v.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};var ee,se,ae;y.parameters={...y.parameters,docs:{...(ee=y.parameters)==null?void 0:ee.docs,source:{originalSource:`{
...
}`,...(ae=(se=y.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};var re,te,ie;g.parameters={...g.parameters,docs:{...(re=g.parameters)==null?void 0:re.docs,source:{originalSource:`{
...
}`,...(ie=(te=g.parameters)==null?void 0:te.docs)==null?void 0:ie.source}}};var ce,le,oe;x.parameters={...x.parameters,docs:{...(ce=x.parameters)==null?void 0:ce.docs,source:{originalSource:`{
...
}`,...(oe=(le=x.parameters)==null?void 0:le.docs)==null?void 0:oe.source}}};var ne,de,he;S.parameters={...S.parameters,docs:{...(ne=S.parameters)==null?void 0:ne.docs,source:{originalSource:`{
...
}`,...(he=(de=S.parameters)==null?void 0:de.docs)==null?void 0:he.source}}};var me,ue,be;j.parameters={...j.parameters,docs:{...(me=j.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    size: 'base',
    variant: 'primary',
...
}`,...(be=(ue=j.parameters)==null?void 0:ue.docs)==null?void 0:be.source}}};const Me=["Default","SizeVariants","ColorVariants","WithLabelsAndDescriptions","StateLabels","Controlled","DisabledStates","FormIntegration","AccessibilityDemo","ThemeShowcase","AllFeatures","Interactive"];export{g as AccessibilityDemo,S as AllFeatures,b as ColorVariants,f as Controlled,m as Default,v as DisabledStates,y as FormIntegration,j as Interactive,u as SizeVariants,w as StateLabels,x as ThemeShowcase,p as WithLabelsAndDescriptions,Me as __namedExportsOrder,Be as default};
