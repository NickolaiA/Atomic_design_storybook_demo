import{j as e}from"./iframe-CY-Mz7KS.js";import"./preload-helper-PPVm8Dsz.js";const s=({size:a="md",direction:i="vertical",spacing:c,flexible:x=!1,className:h="",style:N,"aria-hidden":u=!0,...z})=>{const j=["spacer",`spacer--${a}`,`spacer--${i}`,x&&"spacer--flexible",h].filter(Boolean).join(" "),r={...N};if(c){const t=typeof c=="number"?`${c}px`:c;i==="vertical"?r.height=t:i==="horizontal"?r.width=t:i==="both"&&(r.width=t,r.height=t)}return e.jsx("div",{className:j,style:Object.keys(r).length>0?r:void 0,"aria-hidden":u?"true":"false",...z})};s.__docgenInfo={description:"",methods:[],displayName:"Spacer",props:{size:{required:!1,tsType:{name:"union",raw:"'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl'",elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"},{name:"literal",value:"'2xl'"},{name:"literal",value:"'3xl'"}]},description:"Spacing size variant",defaultValue:{value:"'md'",computed:!1}},direction:{required:!1,tsType:{name:"union",raw:"'vertical' | 'horizontal' | 'both'",elements:[{name:"literal",value:"'vertical'"},{name:"literal",value:"'horizontal'"},{name:"literal",value:"'both'"}]},description:"Direction of spacing",defaultValue:{value:"'vertical'",computed:!1}},spacing:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:"Custom spacing value"},flexible:{required:!1,tsType:{name:"boolean"},description:"Whether the spacer should be flexible (grow to fill space)",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS class",defaultValue:{value:"''",computed:!1}},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:"Custom styles"},"aria-hidden":{required:!1,tsType:{name:"boolean"},description:"ARIA hidden for accessibility",defaultValue:{value:"true",computed:!1}}}};const y={title:"Atoms/Spacer",component:s,parameters:{layout:"padded",docs:{description:{component:`
...
}`,...v.parameters?.docs?.source}}};const g=["Default","VerticalSizes","HorizontalSizes","DirectionVariants","FlexibleSpacing","LayoutExamples","ResponsiveSpacing"];export{o as Default,d as DirectionVariants,m as FlexibleSpacing,n as HorizontalSizes,p as LayoutExamples,v as ResponsiveSpacing,l as VerticalSizes,g as __namedExportsOrder,y as default};
