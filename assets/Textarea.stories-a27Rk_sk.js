import{r as l,j as e,R as be}from"./iframe-C-Dpaqp0.js";import{L as a}from"./Label-a-p-qo0V.js";import"./preload-helper-PPVm8Dsz.js";const r=l.forwardRef(({size:d="md",value:n,defaultValue:q,disabled:x=!1,required:K=!1,placeholder:G="",maxLength:o,showCharacterCount:V=!1,autoResize:i=!1,minRows:D=3,maxRows:I=10,error:B=!1,errorMessage:c,helperText:u,resizable:H="vertical",onChange:$,onFocus:J,onBlur:Q,className:X="",id:p,name:Z,"aria-label":ee,"aria-describedby":re,"aria-labelledby":ae,"aria-invalid":te,rows:se=D,...oe},h)=>{const[k,ie]=l.useState(n||q||""),O=l.useRef(null),le=l.useCallback(t=>{O.current=t,typeof h=="function"?h(t):h&&(h.current=t)},[h]),v=n!==void 0,P=v?n:k,E=P.length,y=l.useCallback(()=>{const t=O.current;if(!t||!i)return;t.style.height="auto";const m=parseInt(getComputedStyle(t).lineHeight,10),Y=parseInt(getComputedStyle(t).paddingTop,10)+parseInt(getComputedStyle(t).paddingBottom,10),ve=t.scrollHeight-Y,ye=Math.ceil(ve/m),fe=Math.max(D,Math.min(I,ye));t.style.height=`${fe*m+Y}px`},[i,D,I]);l.useEffect(()=>{i&&y()},[P,y,i]),l.useEffect(()=>{i&&y()},[y,i]);const de=t=>{const m=t.target.value;o&&m.length>o||(v||ie(m),$&&$(t))},s="textarea",ne=`${s}--${d}`,ce=x?`${s}--disabled`:"",he=B?`${s}--error`:"",me=i?`${s}--auto-resize`:"",xe=H!=="vertical"?`${s}--resize-${H}`:"",ue=[s,ne,ce,he,me,xe,X].filter(Boolean).join(" "),W=u?`${p}-helper`:void 0,_=c?`${p}-error`:void 0,U=V?`${p}-counter`:void 0,pe=[re,W,_,U].filter(Boolean).join(" ");return e.jsxs("div",{className:`${s}-container`,children:[e.jsx("textarea",{ref:le,className:ue,id:p,name:Z,value:v?n:void 0,defaultValue:v?void 0:k,placeholder:G,disabled:x,required:K,maxLength:o,rows:i?void 0:se,onChange:de,onFocus:J,onBlur:Q,"aria-label":ee,"aria-describedby":pe||void 0,"aria-labelledby":ae,"aria-invalid":te||B?!0:void 0,...oe}),(u||c||V)&&e.jsxs("div",{className:`${s}-footer`,children:[e.jsxs("div",{className:`${s}-messages`,children:[c&&e.jsx("div",{id:_,className:`${s}-error-message`,role:"alert","aria-live":"polite",children:c}),u&&!c&&e.jsx("div",{id:W,className:`${s}-helper-text`,children:u})]}),V&&e.jsxs("div",{id:U,className:`${s}-character-count ${o&&E>o*.9?`${s}-character-count--warning`:""}`,"aria-label":`${E}${o?` of ${o}`:""} characters`,children:[E,o&&`/${o}`]})]})]})});r.displayName="Textarea";r.__docgenInfo={description:`Textarea component for multi-line text input.\r
\r
Features:\r
