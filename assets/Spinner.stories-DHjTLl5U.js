...
\r
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive story with all available controls. Use the controls panel below to experiment with different props and see the spinner update in real-time.'
      }
    }
  }
